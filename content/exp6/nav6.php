...
<body>
	<nav>
        <label class="brand-text">FIFO Page Replacement Algorithm</label>
        <div class="nav-wrapper">
		   <a href="../../index.php" class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">home</i></a>
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a href="theory6.php">Theory</a></li>
                <li><a href="obj6.php">Objectives</a></li>
                <li><a href="sim6.php">Simulation</a></li>
                <li><a href="quiz6.php">Quiz</a></li>
            </ul>
