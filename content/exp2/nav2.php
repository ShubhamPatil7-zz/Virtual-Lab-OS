...
<body>
    <nav>
        <label class="brand-text">Shortest Job First</label>
        <div class="nav-wrapper">
            <a href="../../index.php" class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">home</i></a>
            <a class="brand-logo">&emsp;&emsp;&emsp;Shortest Job First</a>
            <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
            <ul class="right hide-on-med-and-down">
                <li><a href="aim2.php">Aim</a></li>
                <li><a href="theory2.php">Theory</a></li>
                <li><a href="obj2.php">Objective</a></li>
                <li><a href="sim2.php">Simulation</a></li>
